...
class UserTest < ActiveSupport::TestCase
  ...
  # end
    def setup 
        @user = User.new ({name: "Example user", email: "dp@example.com", password: "foobar", password_confirmation: "foobar"})
    end 
    ...
    test "user must have a password with minimal length" do
